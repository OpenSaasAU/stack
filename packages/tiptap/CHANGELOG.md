...
- [#1578](https://github.com/OpenSaasAU/stack/pull/1578) [`1486029`](https://github.com/OpenSaasAU/stack/commit/1486029dedfb1e23052a297f4de2ceab552eb9ad) Thanks [@borisno2](https://github.com/borisno2)! - Fix `copy:css` on Windows: replace the POSIX-only `mkdir -p`/`cp` chain with a cross-platform `node -e` call, so the package builds outside a POSIX shell.
