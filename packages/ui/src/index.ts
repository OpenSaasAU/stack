...
export { RelationshipLinkControl } from './components/RelationshipLinkControl.js'
...
export type { RelationshipLinkControlProps } from './components/RelationshipLinkControl.js'
