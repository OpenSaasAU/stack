...
test.describe('Build Validation', () => {
  ...
  test('should have generated the contract and the bundle', async () => {
    // Note: Generation runs in global-setup before tests run
    ...
    for (const generated of [
      ...
      expect(fs.existsSync(path.join(exampleDir, generated)), generated).toBe(true)
    }

    console.log('Contract and bundle validated!')
  })
