...
export type StorageHash =
  StorageHashBase<'7b15b05bbab7fc8a37c1e3d93c2437db3e8324c9b1bc0ab21461d950dcb12ec6'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Post: {
      ...
      readonly viewCount: CodecTypes['pg/int4@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Post: {
      ...
      readonly viewCount: CodecTypes['pg/int4@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly Note: {
              ...
              indexes: readonly [
                {
                  readonly name: 'Note_owner_idx_01158e2c';
                  readonly prefix: 'Note_owner_idx';
                  readonly columns: readonly ['owner'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly Note: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly ownerId: { readonly column: 'owner' };
              };
            };
          };
          readonly Post: {
